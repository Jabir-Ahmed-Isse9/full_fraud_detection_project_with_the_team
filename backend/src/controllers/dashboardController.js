...
async function dashboard(req, res, next) { try { return success(res, { data: await dashboardService.dashboard() }); } catch (error) { return next(error); } }
function models(req, res) { return success(res, { data: dashboardService.modelMetrics() }); }

module.exports = { summary, charts, dashboard, models };
